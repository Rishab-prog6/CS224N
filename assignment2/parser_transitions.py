...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        ###
        self.stack = ["ROOT"]
        self.buffer = sentence[:] # shallow copy of sentence
        self.dependencies = []
    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            # top of stack is head, second-top is dependent
            self.dependencies.append((self.stack[-1], self.stack[-2]))
            self.stack.pop(-2)
        elif transition == "RA":
            # second-top is head, top is dependent
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for pp, transition in zip(mini_batch, transitions):
